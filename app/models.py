...
class Scientist(models.Model):
    ...
    twitter_handler = models.CharField(max_length=100, null=True, blank=True, default=None)
    facebook_profile = models.URLField(null=True, blank=True, default=None)
    gscholar_profile = models.URLField(null=True, blank=True, default=None)
    scopus_profile = models.URLField(null=True, blank=True, default=None)
    linkedin_profile = models.URLField(null=True, blank=True, default=None)
    researchgate_profile = models.URLField(null=True, blank=True, default=None)
    academia_profile = models.URLField(null=True, blank=True, default=None)
    institutional_website = models.URLField(null=True, blank=True, default=None)
